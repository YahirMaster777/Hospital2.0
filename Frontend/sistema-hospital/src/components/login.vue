...
<div class="py-16">
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        <div class="hidden lg:block lg:w-1/2 bg-cover"
            style="background-image:url('https://images.pexels.com/photos/127873/pexels-photo-127873.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')">
        </div>
        <div class="w-full p-8 lg:w-1/2">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <a href="#" class="text-xs text-center text-gray-500 uppercase">O inicia con otra cuenta</a>
                <span class="border-b w-1/5 lg:w-1/4"></span>
            </div>
            <div class="mt-4">
                <label class="block text-gray-700 text-sm font-bold mb-2">Direccion de Correo electronico</label>
            ...
            <div class="mt-8">
                ...
                <button class="bg-gray-700 text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-600">Iniciar Sesion</button>
                </router-link> 
            </div>
            <div class="mt-4 flex items-center justify-between">
